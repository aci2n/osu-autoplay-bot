...
int _tmain(int argc, _TCHAR* argv[])
{
	try
	{
		BeatmapParser parser(R"(C:\Users\alvaro.daniel.calace\AppData\Local\osu!\Songs\118768 xi - Akasha\xi - Akasha (Jemmmmy) [Extreme].osu)");
		...
		CoordinatesTranslator().translate_coordinates(windowRect, beatmap.get_hit_objects());
		Player player(*beatmap.get_hit_objects(), desktopRect);
